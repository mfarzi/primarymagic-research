#!/usr/bin/env python
"""Decoupled-v1 Experiment: 26-class encoder with 6-class sequencer.
...
Uses primary_magic data with multi-rep support and min_spectra=40 filtering.
Each random-selection step is repeated 5 times for statistical reliability.
...
Usage:
    python scripts/run_decoupled_v1.py                        # Run everything
    python scripts/run_decoupled_v1.py --phase 1              # Encoder only
    python scripts/run_decoupled_v1.py --phase 2              # Sequencer training
    python scripts/run_decoupled_v1.py --phase 3              # Sequencer evaluation
    python scripts/run_decoupled_v1.py --start-step 2 --end-step 2 --run 1  # Single step+run
"""
...
CHECKPOINT_BASE = Path("checkpoints/decoupled_v1")
RESULTS_BASE = Path("results/decoupled_v1")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run Decoupled-v1 experiment pipeline (26-class encoder, 6-class sequencer)",
...
def main():
    ...
    print("=" * 70)
    print("Decoupled-v1 Experiment Pipeline")
    print("=" * 70)
